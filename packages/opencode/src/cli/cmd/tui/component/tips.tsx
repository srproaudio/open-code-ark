...
const TIPS = [
  ...
  "Architect Agent auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Architect Agent auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Architect Agent uses LSP servers for intelligent code analysis",
